...
export default function ColmschatePage() {
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10 w-full max-w-[1200px]">
          <div className="max-w-2xl">
            ...
            <p className="text-xl md:text-2xl text-white/95 mb-8 md:mb-10 leading-relaxed drop-shadow-lg">
              Zonnestudio in Deventer Colmschate met moderne zonnebanken en professionele apparatuur.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
                Onze studio in Colmschate biedt moderne zonnebanken in een rustige en hygiënische omgeving. 
            ...
            <div className="rounded-xl overflow-hidden shadow-lg">
              <img 
                src="/hero/sunhofbinnen.jpg" 
                alt="Interieur Sunhof Colmschate" 
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
              ...
              <div 
                ...
                onClick={() => setLightboxImage("/colmschate/sunhof-colmschate1.jpg")}
                onMouseMove={(e) => handleMouseMove(e, "photo1")}
                onMouseLeave={() => handleMouseLeave("photo1")}
              >
                <div className="relative overflow-hidden aspect-[4/3]">
                  <img 
                    src="/colmschate/sunhof-colmschate1.jpg" 
                    alt="Studio foto 1" 
              ...
              <div 
                ...
                onClick={() => setLightboxImage("/colmschate/sunhof-colmschate2.jpg")}
              ...
              >
                <div className="relative overflow-hidden h-full w-full bg-gray-50">
                  <img 
                    src="/colmschate/sunhof-colmschate2.jpg" 
                    alt="Studio foto 2" 
                    className="w-full h-full object-cover transition-transform duration-500 ease-out"
                    style={{
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div 
                ...
                onClick={() => setLightboxImage("/colmschate/sunhof-colmschate4.jpg")}
                onMouseMove={(e) => handleMouseMove(e, "photo4")}
                onMouseLeave={() => handleMouseLeave("photo4")}
              >
                <div className="relative overflow-hidden aspect-[4/3]">
                  <img 
                    src="/colmschate/sunhof-colmschate4.jpg" 
                    alt="Studio foto 4" 
                    className="w-full h-full object-cover transition-transform duration-500 ease-out"
                    style={{
              ...
              <div 
                className="rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 group cursor-pointer border-2 border-white/50"
                onClick={() => setLightboxImage("/colmschate/sunhof-colmschate3.jpg")}
                onMouseMove={(e) => handleMouseMove(e, "photo3")}
                onMouseLeave={() => handleMouseLeave("photo3")}
              >
                <div className="relative overflow-hidden aspect-[4/3]">
                  <img 
                    src="/colmschate/sunhof-colmschate3.jpg" 
                    alt="Studio foto 3" 
                    className="w-full h-full object-cover transition-transform duration-500 ease-out"
                    style={{
        ...
        <div className="container mx-auto px-4 max-w-[1200px]">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#1F1F1F] mb-4">
              Onze zonnebanken in Colmschate
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 flex flex-col overflow-hidden border border-gray-100">
              ...
              <div className="relative overflow-hidden aspect-[4/3] bg-gray-50">
                <img 
                  src="/zonnebanken/Affinity600.png" 
                  alt="Affinity 600" 
                  className="w-full h-full object-cover"
                />
              </div>
            ...
            <div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-md space-y-6">
                ...
                <div>
                  ...
                  <p className="text-gray-700">0570 752 247</p>
                </div>
      ...
      <section className="py-16 md:py-24 bg-[#F6F3EE]">
        <div className="container mx-auto px-4 max-w-[1200px]">
          ...
          <div className="rounded-xl overflow-hidden shadow-lg" style={{ height: '350px' }}>
            <iframe
              src="https://www.google.com/maps?q=Koggeschip+216+Deventer&output=embed"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
